...
function installBaseSoftware()
{
    ...
    echo "  2.4 安装GUI软甲"
    sudo ${INSTALL} zeal dukto simplescreenrecorder gcolor2 xarchiver clipit gitg thunderbird shadowsocks-qt5 nautilus-nutstore netease-cloud-music vlc notepadqq sqlitestudio redshift virtualbox sogoupinyin google-chrome-stable typora electronic-wechat albert meld screenruler persepolis
    echo "安装pip软件"
