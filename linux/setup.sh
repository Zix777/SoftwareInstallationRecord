...
function installBaseSoftware()
{
    ...
    echo "  2.4 安装GUI软甲"
    sudo ${INSTALL} zeal dukto simplescreenrecorder gcolor2 xarchiver clipit gitg thunderbird shadowsocks-qt5 nautilus-nutstore netease-cloud-music vlc notepadqq sqlitestudio redshift virtualbox sogoupinyin google-chrome-stable typora electronic-wechat albert screenruler
    echo "安装pip软件"
...
function configCliSoftware()
{
    ...
    sudo sed -i "s/socks4   127.0.0.1 9050/socks    127.0.0.1 1080/g" /etc/proxychains.conf
}
